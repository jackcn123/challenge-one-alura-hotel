...
public class RegistroHuesped extends JFrame {
	 ...
	 * Create the frame.
	 */
	public RegistroHuesped(String numreserva) {
	...
	private void guardar(String numreserva) {
		if (txtFechaN.getDate() != null && (!txtNombre.getText().isBlank()) && (!txtApellido.getText().isBlank())
				&& (!txtTelefono.getText().isBlank())) {
			String nacionalidad = (String) txtNacionalidad.getSelectedItem();
			Date fechanac = Date.valueOf(((JTextField) txtFechaN.getDateEditor().getUiComponent()).getText());
			int telefono = Integer.parseInt(txtTelefono.getText());

			Huespedes huespedes = new Huespedes(txtNombre.getText(), txtApellido.getText(), fechanac, nacionalidad,
					telefono, Integer.parseInt(numreserva));
			huespedesController.guardar(huespedes);
			Exito dialog = new Exito(numreserva);
